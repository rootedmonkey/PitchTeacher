...
Process Name: clock
PID: 22451
Date: 2015-09-11 17:29:18+0900
Executable File Path: /opt/usr/apps/org.samteam.perfectsong/bin/clock
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 22451, uid 5000)
...
Threads: 4
PID = 22451 TID = 22451
22451 22458 22459 22462 

Maps Information
b03ff000 b0bfe000 rwxp [stack:22462]
b1000000 b17ff000 rwxp [stack:22459]
b1c01000 b2400000 rwxp [stack:22458]
...
b8985000 b8cdf000 rw-p [heap]
beccd000 becee000 rwxp [stack]
End of Maps Information

Callstack Information (PID:22451)
Call Stack Count: 1
...
e_anti_shake failed - code[c0000002][0m
...
09-11 17:29:11.595+0900 W/CRASH_MANAGER(22433): worker.c: worker_job(1198) > 1122408636c6f1441960151
09-11 17:29:11.755+0900 I/SYSPOPUP(  627): syspopup.c: __X_syspopup_term_handler(98) > enter syspopup term handler
09-11 17:29:11.765+0900 I/SYSPOPUP(  627): syspopup.c: __X_syspopup_term_handler(108) > term action 1 - volume
09-11 17:29:11.765+0900 E/VOLUME  (  627): volume_x_event.c: volume_x_input_event_unregister(351) > [volume_x_input_event_unregister:351] (s_info.event_outer_touch_handler == NULL) -> volume_x_input_event_unregister() return
...
09-11 17:29:18.525+0900 W/CRASH_MANAGER(22433): worker.c: worker_job(1198) > 1122451636c6f144196015
